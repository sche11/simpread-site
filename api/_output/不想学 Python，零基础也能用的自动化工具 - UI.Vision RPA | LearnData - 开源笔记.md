> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [newzone.top](https://newzone.top/_posts/2022-04-21-uivision_rpa.html#%E5%AE%89%E8%A3%85-ui-vision)
...
[#](#安装-ui-vision) 安装 UI.Vision
-------------------------------

UI.Vision RPA 的主体是浏览器插件，只需去应用商店即可完成安装。

*   Chrome 插件：[https://chrome.google.com/webstore/detail/uivision-rpa/gcbalfbdmfieckjlnblleoemohcganocopen in new window](https://chrome.google.com/webstore/detail/uivision-rpa/gcbalfbdmfieckjlnblleoemohcganoc)
*   Firefox 插件：[https://addons.mozilla.org/zh-CN/firefox/addon/rpa/open in new window](https://addons.mozilla.org/zh-CN/firefox/addon/rpa/)
*   Edge 插件：[https://microsoftedge.microsoft.com/addons/detail/uivision-rpa - 浏览器自动化工具 / goapmjinbaeomoemgdcnnhoedopjndddopen in new window](https://microsoftedge.microsoft.com/addons/detail/uivision-rpa-%E6%B5%8F%E8%A7%88%E5%99%A8%E8%87%AA%E5%8A%A8%E5%8C%96%E5%B7%A5%E5%85%B7/goapmjinbaeomoemgdcnnhoedopjnddd)
...
*   第 5-8 步使用「click」命令，依次点击指定按钮。
    ...
    ![](http://tc.seoipo.com/2022-04-21-17-15-59.png)
...
用不同的变量文本进行重复的网页操作，需要使用 UI.Vision 的 [csvReadopen in new window](https://ui.vision/rpa/docs/selenium-ide/csvread) 命令。下面以「依次打开不同链接」为例。
...
*   [UI.Vision RPA 浏览器自动化工具：表单填写、网页内容抓取、网页操作录制 open in new window](https://www.appinn.com/ui-vision-rpa/)
*   [UI.Vision 命令官方文档 open in new window](https://ui.vision/rpa/docs/selenium-ide)
*   [白话 UI.Vision Kantu 插件 open in new window](https://github.com/LoveOctocat/UI.Vision-Kantu-ZH)